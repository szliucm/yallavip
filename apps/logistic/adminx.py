...
class LogisticCustomerServiceAdmin(object):
    ...
    search_fields = [ 'logistic_no' ]
    list_filter = ('logistic_track_code', 'logistic_start_date','logistic_update_date', 'logistic_update_status', 'deal','package_status','yallavip_package_status','from_warehouse',)
    ordering = ['send_time']
...
class OverseaPackageAdmin(object):
    list_display = ('ref_order', 'send_time','logistic_no','logistic_update_date', 'logistic_update_status','logistic_update_locate',
                    )
