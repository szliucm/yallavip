...
from  prs.common import  FREE_SHIPPING_COUNT, PROMOTE_COUNT, CATE_TYPE
...
class MyCategory(models.Model):
    ...
    fullname = models.CharField(u'品类全名', default='', max_length=100, null=True, blank=True)
...
class Lightin_SPU(models.Model):
    ...
    cate_1 = models.CharField(u'cate_1', default='', max_length=20, null=True, blank=True)
    cate_2 = models.CharField(u'cate_2', default='', max_length=20, null=True, blank=True)
    cate_3 = models.CharField(u'cate_3', default='', max_length=20, null=True, blank=True)
    ...
    old_images = models.TextField(default='', null=True, blank=True, verbose_name="图片")
...
class Lightin_SKU(models.Model):
    ...
    ori_image = models.TextField(default='', null=True, blank=True, verbose_name="原sku图")
...
class Lightin_barcode(models.Model):
    ...
    def cal_sellable(self):
        occupied = self.cal_occupied()
        if self.o_sellable :
            return self.o_sellable - occupied
        else:
            return 0
