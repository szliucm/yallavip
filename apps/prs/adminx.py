...
class Lightin_SKUAdmin(object):
    ...
    list_display = ["SKU", "handle",  "size","skuattr", "o_sellable","free_shipping_count", "promote_count", "sku_photo", "sku_price",]

    # 'sku_name','img',
    search_fields = ["SPU", "SKU","lightin_spu__handle","lightin_spu__en_name",]
