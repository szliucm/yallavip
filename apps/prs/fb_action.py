...
Ad_Tokens = ["EAAHZCz2P7ZAuQBADanYOntraUNad6wcylZAWEqrvI7plKW6jg5n1YmvRu5QSPrWpZCrv1ZATZCdeCfPgSLPmjOSFgXcfTslnwxIC341e47GkNKzsRfzWI0S0WiwuxYhkENRbF4iVZBJEEWxWqXtG4jB5ZCobi6ZAcNvGHl0AJ0UDr57lKmfUyQQhX"]
#"EAAGOOkWV6LgBAAU5qdiOCZBL2qYsfaz5W0t3FYZC1uSUq8RWlv2OxmfL8OsEUrTAAl5HG5CB2iF7rhxPoMc3hfqFGzsADU0ZAkyqjSpMqQZAzGZCLJ2yZBosxErZA3J4jlgrE2AjTIYC0bHn6mnRZCPX8ouQuDB8ZCu0E3LnRMfGLZC6xZAfLITrCsH",
...
def combo_ad_image_v4(spu_ims, spus_name,spus, page_no):
    ...
    if item_count == 2:
        # 两张图
        # 1600*838的画布
        layer = Image.new("RGB", (1600, 838), "white")


        layer.paste(clipResizeImg_new(ims[0], 800, 800), (0, 0))
        layer.paste(clipResizeImg_new(ims[1], 800, 800), (800, 0))
    ...
    if page_no:
        ...
        for spu in spus:
            ...
            draw.text((int(price_postion_1[0]) - w, int(price_postion_1[1])), str(price1), (255, 255, 255),
                      font=font)  # 设置文字位置/内容/颜色/字体
            ...
            draw.text((int(price_postion_2[0]) - w, int(price_postion_2[1])), str(price2), (255, 182, 193),
                      font=font)  # 设置文字位置/内容/颜色/字体
            draw = ImageDraw.Draw(layer)
