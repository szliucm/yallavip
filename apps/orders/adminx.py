...
class OrderAdmin(object):
    ...
    list_display = ["order_no", "status","stock", "cal_barcode", "inventory_status", "wms_status","fulfill_error","order_amount", "order_time", "logistic_no","order_comment"]
...
class OrderDetailAdmin(object):
    ...
    list_display = ['order', 'sku',"handle","skuattr", 'product_quantity','stock', 'outstock','inventory_status', 'price','order_status','show_supply_status','alternative', ]
