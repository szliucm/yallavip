...
class PromoteTemplateAdmin(object):
    ...
    list_display = ('batch_name', 'size', 'freeshipping','show_promote_template','main_image_count','sub_image_count','price_postion','oriprice_postion','update_time',)
    list_editable = ['batch_name', 'size','freeshipping', 'main_image_count','sub_image_count','price_postion','oriprice_postion',]
    search_fields = []
